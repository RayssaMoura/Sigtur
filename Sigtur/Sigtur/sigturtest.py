...
def criar_turma():
    ...
    # Verificar se algum aluno já está cadastrado na turma
    for aluno_nome in alunos_turma:
        if aluno_nome in alunos:
            aluno = alunos[aluno_nome]
            if nome_turma in aluno["turmas"]:
                print("Aluno já matriculado na turma. Digite novamente.")
                return  # Retorna para interromper a criação da turma
